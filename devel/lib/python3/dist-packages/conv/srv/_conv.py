...
class convRequest(genpy.Message):
  _md5sum = "b69413d1c5fc23dea379049f7250e8aa"
  _type = "conv/convRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 srcmatrix_A_rownum
...
uint8[] srcmatrix_B
"""
  __slots__ = ['srcmatrix_A_rownum','srcmatrix_A_colnum','srcmatrix_A','srcmatrix_B_rownum','srcmatrix_B_colnum','srcmatrix_B']
  _slot_types = ['int32','int32','int8[]','int32','int32','uint8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       srcmatrix_A_rownum,srcmatrix_A_colnum,srcmatrix_A,srcmatrix_B_rownum,srcmatrix_B_colnum,srcmatrix_B
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i().pack(_x.srcmatrix_A_rownum, _x.srcmatrix_A_colnum))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.srcmatrix_A_rownum, _x.srcmatrix_A_colnum,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
...
class conv(object):
  _type          = 'conv/conv'
  _md5sum = '8a5391416c94b934abefe3529f6e4d67'
